 ...
 * @Version 1.0
 **/
public class ProduceImageToPDF {
     ...
     * 身份证反面
     */
    private static String ID_CARD_FAN = "";
    /**
     * 身份证正面-临时
     */
     ...
     * 身份证反面-临时
     */
    private static String TEMP_ID_CARD_FAN_NAME = "temp_id_card_fan.jpg";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 身份证正面
        /*ID_CARD_ZHE = "ID_CARD1.jpg";
        // 身份证反面
        ID_CARD_FAN = "ID_CARD2.jpg";*/
        // 身份证正面
       /* ID_CARD_ZHE = "46.jpg";
        // 身份证反面
        ID_CARD_FAN = "47.jpg";*/
        // 身份证正面
        ID_CARD_ZHE = "zheng.jpg";
        // 身份证反面
        ID_CARD_FAN = "fan.jpg";
    ...
    private static String imageAndTemplatePdf2NewPdf(Map<String, String> imgMap) {
        // 模板pdf文件路径
        String templatePath = "F:\\pdf\\img_template3.pdf";
        // 生成的新文件路径
        String newPDFPath = "F:\\total3.pdf";
